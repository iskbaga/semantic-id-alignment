...
def generate_constants(cfg: DictConfig):
    ...
    results_path = os.path.join(cfg.paths.results_dir, rqvae_split_name, f'rqvae-{cfg.dataset.rqvae.model_name}')
    ...
    return {
        ...
        'ALL_ITEMS_SEMANTIC_MAPPING_PATH': os.path.join(results_path, 'all_clusters_colisionless.json'),
        'TRAIN_PART_SEMANTIC_MAPPING_PATH': os.path.join(
            results_path,
